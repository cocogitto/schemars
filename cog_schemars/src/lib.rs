...
/// This module is only public for use by `cog_schemars_derive`. It should not need to be used by code
/// outside of `cog_schemars`, and should not be considered part of the public API.
#[doc(hidden)]
pub mod _private;
pub mod generate;
pub mod transform;

#[cfg(feature = "cog_schemars_derive")]
extern crate cog_schemars_derive;
use alloc::borrow::Cow;

#[cfg(feature = "cog_schemars_derive")]
pub use cog_schemars_derive::*;
...
#[deprecated = "Only included for backward-compatibility - use the `cog_schemars::generate` module instead."]
#[doc(hidden)]
pub mod r#gen {
    #[deprecated = "Only included for backward-compatibility - use `cog_schemars::SchemaGenerator` or `cog_schemars::generate::SchemaGenerator` instead."]
    pub type SchemaGenerator = crate::generate::SchemaGenerator;
    #[deprecated = "Only included for backward-compatibility - use `cog_schemars::generate::SchemaSettings` instead."]
    pub type SchemaSettings = crate::generate::SchemaSettings;
    #[deprecated = "Only included for backward-compatibility - use `cog_schemars::generate::GenTransform` instead."]
...
/// ```
/// use cog_schemars::{SchemaGenerator, Schema, JsonSchema, json_schema};
/// use std::borrow::Cow;
///
...
pub trait JsonSchema {
    ...
    #[doc(hidden)]
    fn _cog_schemars_private_non_optional_json_schema(generator: &mut SchemaGenerator) -> Schema {
