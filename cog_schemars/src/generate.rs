...
impl SchemaSettings {
    ...
    /// # Example
    /// ```
    /// use cog_schemars::generate::{SchemaGenerator, SchemaSettings};
    ///
...
/// # Example
/// ```
/// use cog_schemars::{JsonSchema, SchemaGenerator};
///
/// #[derive(JsonSchema)]
/// struct MyStruct {
///     foo: i32,
...
impl SchemaGenerator {
    ...
    /// # Example
    /// ```
    /// use cog_schemars::SchemaGenerator;
    ///
    /// let generator = SchemaGenerator::default();
...
/// # Example
/// ```
/// use cog_schemars::transform::Transform;
/// use cog_schemars::generate::GenTransform;
///
/// #[derive(Debug, Clone)]
/// struct MyTransform;
///
/// impl Transform for MyTransform {
///   fn transform(&mut self, schema: &mut cog_schemars::Schema) {
///     todo!()
///   }
/// }
///
...
pub trait GenTransform: Transform + DynClone + Any + Send {
    ...
    /// ```
    /// use cog_schemars::generate::SchemaSettings;
    /// use cog_schemars::transform::ReplaceBoolSchemas;
    ///
