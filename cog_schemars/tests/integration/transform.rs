...
#[cog_schemars(transform = RecursiveTransform(insert_upper_type), transform = insert_property_count)]
struct Struct {
    value: Value,
    #[cog_schemars(transform = insert_property_count)]
    int: i32,
}
...
fn assert_upper_type_valid(schema: &Schema, _: cog_schemars::generate::Contract) {
