...
#[allow(dead_code)]
#[derive(JsonSchema)]
#[cog_schemars(description = "New description")]
struct OverrideDocs {
    /// # Overridden
    #[cog_schemars(title = "My integer", description = "This is an i32")]
    my_int: i32,
    /// # Overridden
    /// Also overridden
    #[cog_schemars(title = "", description = "")]
    my_undocumented_bool: bool,
    #[cog_schemars(title = concat!("Documented ", "bool"), description = "Capitalized".to_uppercase())]
    my_documented_bool: bool,
}
